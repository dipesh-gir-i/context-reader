        ...
        <aside className={`panel ${panelOpen ? '' : 'hidden'}`} style={{width:settings.panelWidth}}>
          ...
          <div className="panel-body">
            ...
            {context && <div className="word-card">
              ...
              {answer && <><div className="field"><div className="field-label">Meaning in this passage</div><div className="field-copy">{answer.meaning}</div></div><div className="field"><div className="field-label">Why this meaning fits</div><div className="field-copy">{answer.explanation}</div></div><div className="field"><div className="field-label">Example</div><div className="field-copy">{answer.example}</div></div></>}
